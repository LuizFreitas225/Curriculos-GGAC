...
import br.unitins.curriculoggac.servlet.ImgUsuarioServlet;
...
public class Util {
	...
	public static boolean saveImageUsuario(InputStream inputStream, String imageType, String idUsuario) {
